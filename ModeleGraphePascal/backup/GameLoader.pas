...
begin
  ...
  // === CHEMINS EN DUR POUR TEST (Windows) ===
  ImagePath := 'saved\CarteNord1870\CarteNord1870.png';
  NodesPath := 'saved\CarteNord1870\dataGraph.csv';
  EdgesPath := 'saved\CarteNord1870\voie.csv';
